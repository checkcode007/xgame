package com.gamefull.cache.service;

import com.gamefull.cache.CacheManager;
...
import com.gamefull.cache.util.CacheUtil;
import com.gamefull.util.FastJsonUtil;
...
public class CacheAdvice2 {
    ...
    @Pointcut("@annotation(com.gamefull.cache.annotation.XCacheAble)")
    private void able() {}
    @Pointcut("@annotation(com.gamefull.cache.annotation.XCacheEvict)")
    private void evict() {}
    @Around("able()")
