package com.proto.cache.service;

import com.proto.cache.CacheManager;
import com.proto.cache.annotation.XCacheAble;
import com.proto.cache.annotation.XCacheEvict;
import com.proto.cache.bean.ICaches;
import com.proto.cache.util.CacheUtil;
import com.proto.util.FastJsonUtil;
...
public class CacheAdvice2 {
    ...
    @Pointcut("@annotation(com.proto.cache.annotation.XCacheAble)")
    private void able() {}
    @Pointcut("@annotation(com.proto.cache.annotation.XCacheEvict)")
    private void evict() {}
    @Around("able()")
