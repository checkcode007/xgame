...
public class RecordTest {
    ...
    private static void printPoints(Object object) {
        ...
        switch (object) {
            ...
            case Points position -> System.out.println("111pre jdk 19 object is a position, x = " + position.x()
                    + ", y = " + position.y());
        ...
        switch (object) {
            ...
            case Points(int x, int y) -> System.out.println(" 222jdk 19 object is a position, x = " + x
                    + ", y = " + y);
            default -> throw new IllegalStateException("Unexpected value: " + object);
        }
    ...
    public static void printLine(Object object) {
        ...
        switch (object) {
            ...
            case Line(Points(int x1, int y1), Points(int x2, int y2)) ->
                    System.out.println("111object is a path, x1 = " + x1 + ", y1 = " + y1
                            + ", x2 = " + x2 + ", y2 = " + y2);
            // other cases ...
            default -> throw new IllegalStateException("Unexpected value: " + object);
        }
